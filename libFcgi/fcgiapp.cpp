	...
	for (;;) {
		...
		*/
		...
		}
		{
			...
			PutParam(reqDataPtr->paramsPtr, StringCopy(roleStr.c_str()));
		}
...
bool ReadRequest(FCGX_Request* request)
{
	...
	}
	{
		...
		PutParam(request->paramsPtr, StringCopy(roleStr.c_str()));
	}
...
void SetRequestWriter(FCGX_Request* request)
{
